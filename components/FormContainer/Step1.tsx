            ...
            <div className='flex flex-col gap-6'>
                ...
                >
                    <div className='max-w-[340px]  mx-auto'>
                        <h1 className='font-[family-name:var(--font-road-rage)]  text-6xl text-[#FAFAFA]' > Techember Fest ”25</h1>
                        <p className='font-[family-name:var(--font-roboto)] text-base font-normal leading-relaxed text-[#FAFAFA]'>Join us for an unforgettable experience at [Event Name]! Secure your spot now</p>
                        <p className='font-[family-name:var(--font-roboto)]  mt-2 text-base font-normal leading-relaxed text-[#FAFAFA]'>📍[Event Location]  | |  March 15, 2025 | 7:00 PM</p>
                    </div>
                </div>
                ...
                <div className='flex flex-col gap-2 font-[family-name:var(--font-roboto)]'>
                    ...
                    <div className='w-full flex p-4 bg-[#052228] border border-[#07373F] gap-4 rounded-3xl'>
                        {ticketType.map((ticket, index) => (
                            <div key={index} className="w-1/3 p-3 rounded-xl hover:bg-[#2C545B] border border-[#197686]">
