...
const Navbar = () => {
    ...
    return (
        <div className="w-full flex justify-center px-4 ">
            <div className='max-w-[1200px] mx-auto border rounded-3xl border-[#197686] bg-[#05252c4d] mt-3 p-3 w-full flex items-center justify-center' style={{ fontFamily: 'Jeju Myeongjo, serif', fontWeight: '300' }}>
